      ...
      <div class="w-full mx-auto flex flex-wrap">
        <div class="flex w-full lg:w-1/2">
          <div class="px-3 md:px-0">
            ...
            <p class="py-4">
              Web shopping, or online shopping, enables people to buy goods and
              services via the internet. It's convenient, available 24/7, and
              offers a vast array of choices. Secure payments and delivery
              services make transactions smooth and reliable.
            </p>
          </div>
        </div>
        <div
